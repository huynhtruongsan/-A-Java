...
<div class="w3-row w3-container">
  <div class="w3-col s3 w3-green w3-center">
    <div class="w3-card-2 w3-white">
	  <img src="${pageContext.request.contextPath}/admin/quan-li-tin-tuc/hien-thi-hinh-anh?id=${cttt.getIdtintuc()}" alt="" style="width:100%">
		  <div class="w3-container">
		  <h3>${cttt.getTentintuc() }</h3>
		  <p>${cttt.getNgaydang() }</p>
		  <p>${cttt.getMotangan() }</p> 
		  </div>
	  </div>
  </div>
