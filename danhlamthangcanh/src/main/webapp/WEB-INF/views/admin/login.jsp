...
<html>
    ...
    <body class="cbp-spmenu-push">
        <div class="main-page login-page ">
            <div class="widget-shadow" style="background-color:#f5f5f5">
                <div class="login-top">
                    <h2>Đăng nhập </h2>
                </div>
                <div class="login-body" >
                    <form:form action="${pageContext.request.contextPath}/admin" method="post">
                        <form:input class="user" path="email" />
                        <form:password class="lock" path="matkhau" />
                        <div class="forgot-grid">
                            <p style="color: red; text-align:center">${erro}</p>          
                        </div>
                        <input type="submit" value="Đăng nhập" style="background-color: green">
