            ...
            <jsp:include page="header.jsp"></jsp:include>
                <div id="page-wrapper">
                    <div class="main-page">
                        <div class="forms">
                            <div class="row">
                                <h3 class="title1">Thêm tài khoản </h3>
                                <div class="form-three widget-shadow">
                                    <form:form class="form-horizontal"  method="post" action="${pageContext.request.contextPath}/admin/quan-li-tai-khoan/them-tai-khoan" >
