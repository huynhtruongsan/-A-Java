<%-- 
    Document   : manager_tintuc
    Created on : Apr 14, 2016, 9:56:33 AM
    Author     : CONG MINH
--%>
                    ...
                    <div class="main-page">
                        <div class="tables">
                            <div class="table-responsive bs-example widget-shadow">
                                <h4>Danh Sách Tin Tức</h4> <a href="${pageContext.request.contextPath}/admin/quan-li-tin-tuc/them-tin-tuc">Thêm tin tức</a>
                            <table class="table table-bordered" style="margin-top: 20px">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="t" items="${listNews}">
                                        <c:set var="num" value="${num + 1}" />
                                        <tr> 
                                            <th scope="row"><c:out value="${num}"></c:out></th>
                                            <td>${t.tentintuc}</td>
                                         
                                            <td><img width="200px" src="${pageContext.request.contextPath}/admin/quan-li-tin-tuc/hien-thi-hinh-anh?id=${t.idtintuc}" alt="" /></td> 
                                            <c:if test="${t.getLoaitin().idloaitin == '1'}">
                                                <td style="color: green">Du lịch</td>
                                            </c:if>
                                            <c:if test="${t.getLoaitin().idloaitin == '2'}">
                                                <td style="color: red">Sự kiện</td>
                                            </c:if>
                                            <td style="width: 100px">${t.ngaydang}</td> 
                                            <c:if test="${t.getTaikhoan().idtaikhoan == '1'}">
                                                <td>Admin</td>
                                            </c:if>
                                            <td style="width: 100px"><a href="${pageContext.request.contextPath}/admin/quan-li-tin-tuc/sua-tin-tuc?idtintuc=${t.idtintuc}">Sửa</a>
                                             | <a href="${pageContext.request.contextPath}/admin/quan-li-tin-tuc/xoa-tin-tuc?idtintuc=${t.idtintuc}">Xóa</a></td> 
                            ...
                            <div id="page-info" style="float: right">Trang 
                                <c:forEach var="i" begin="1" end="${size}">
                                    <a href="${pageContext.request.contextPath}/admin/news/indexp?p=${i-1}" id="page-info" > <strong>${i}</strong> </a>
                                </c:forEach>
                            </div>
