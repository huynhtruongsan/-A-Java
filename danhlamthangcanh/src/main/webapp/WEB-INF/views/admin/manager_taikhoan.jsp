                    ...
                    <div class="main-page">
                        <div class="tables">
                            <div class="table-responsive bs-example widget-shadow">
                                <h4>Danh Sách Tin Tức</h4> <a href="${pageContext.request.contextPath}/admin/quan-li-tai-khoan/them-tai-khoan">Thêm tài khoản</a>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="l" items="${listTaiKhoan}">
                                        ...
                                        <tr> 
                                            ...
                                            <td>${l.ngaytao}</td>
                                            <c:if test="${num >1 }">
                                            <td style="width: 100px"><a href="${pageContext.request.contextPath}/admin/quan-li-tai-khoan/sua-tai-khoan?idtaikhoan=${l.idtaikhoan}">Sửa</a>
                                             | <a href="${pageContext.request.contextPath}/admin/quan-li-tai-khoan/xoa-tai-khoan?idtaikhoan=${l.idtaikhoan}">Xóa</a></td> 
                                             </c:if>
