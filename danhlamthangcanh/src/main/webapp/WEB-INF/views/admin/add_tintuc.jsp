                        ...
                        <div class="forms">
                            <div class="row">
                                ...
                                <div class="form-three widget-shadow">
                                    <form:form class="form-horizontal"  method="post" action="${pageContext.request.contextPath}/admin/quan-li-tin-tuc/them-tin-tuc" 
                                    ...
                                    <div class="form-group">
                                        <form:label for="focusedinput" class="col-sm-2 control-label" path="hinhanh">Chọn hình ảnh:</form:label>
                                        <div class="col-sm-8">
                                            <td></td>  <td ><input type="file" name="fileUpload"></td>
                                        </div>
                                        <div class="col-sm-2">
